  ...
  async execute(interaction, context) {
    ...
    try {
      ...
      if (targetRole.position >= botMember.roles.highest.position) {
        return interaction.editReply({
          content: "<:errorwarningline:1510529314515320944> | 該身份組的權限高於我，無法移除",
        });
      }
      ...
      const embed = new EmbedBuilder()
        .setTitle("身份組移除成功")
        .setDescription(
          `已為 ${targetUser} 移除身份組 **${targetRole.name}**`,
        )
        .setColor(0xff6b6b)
        .setTimestamp()
      ...
      await interaction.editReply({ content: "<:errorwarningline:1510529314515320944> | 移除身份組時發生錯誤" });
    }
  },
};